...
partial class MenuPrincipal
{
    ...
    private void InitializeComponent()
    {
        ...
        ImposicionEnCallCenterBtn = new Button();
        ImposicionEnCDBtn = new Button();
        AdmisionBtn = new Button();
        EmisionUltimaMillaBtn = new Button();
        RendicionUltimaMillaBtn = new Button();
        EmisionTransporteBtn = new Button();
        RendicionTransporteBtn = new Button();
        EntregaEncomiendaBtn = new Button();
        ConsultaEstadoBtn = new Button();
        ...
        Controls.Add(ConsultaEstadoBtn);
        Controls.Add(EntregaEncomiendaBtn);
        Controls.Add(RendicionTransporteBtn);
        Controls.Add(EmisionTransporteBtn);
        Controls.Add(RendicionUltimaMillaBtn);
        Controls.Add(EmisionUltimaMillaBtn);
        Controls.Add(AdmisionBtn);
        Controls.Add(ImposicionEnCDBtn);
        Controls.Add(ImposicionEnCallCenterBtn);
    ...
    private Button ImposicionEnCallCenterBtn;
    private Button ImposicionEnCDBtn;
    private Button AdmisionBtn;
    private Button EmisionUltimaMillaBtn;
    private Button RendicionUltimaMillaBtn;
    private Button EmisionTransporteBtn;
    private Button RendicionTransporteBtn;
    private Button EntregaEncomiendaBtn;
    private Button ConsultaEstadoBtn;
