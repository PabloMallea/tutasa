...
namespace tutasa.RuteoTransporte
{
    public partial class FormRuteoTransporte : Form
    {
        ...
        private void BtnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "El servicio no posee capacidad suficiente para las encomiendas seleccionadas.",
                    "Capacidad excedida",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Warning
                );
            ...
            {
                MessageBox.Show(
                    "Todas las encomiendas seleccionadas ya fueron asignadas previamente al servicio.",
                    "Validación",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Warning
                );
            ...
            if (ComboEmpresa.SelectedValue is int idEmpresa &&
                ComboCDDestino.SelectedValue is int idCDDestino)
            {
                ComboServicio.DataSource =
                    modelo.ObtenerServicios(idEmpresa, idCDDestino);
